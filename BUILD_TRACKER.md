...
| M40 — Widgets I: Stateful Controls | `███░░░░░░░` 33% | 🚧 In progress — Phase 2 of 6 done (2026-09-25) |
...
**Just closed:** M40 Phase 2 (2026-09-25) — MD3's radio button (with `RadioGroup`: one selected, one Tab stop, arrow keys) and switch; 1114 → 1127. Before that, M40 Phase 1 (same day) — the control foundation, proved on the checkbox.
