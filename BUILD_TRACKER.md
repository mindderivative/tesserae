...
| M40 — Widgets I: Stateful Controls | `████████░░` 83% | 🚧 In progress — Phase 5 of 6 done (2026-09-25) |
...
**Just closed:** M40 Phase 5 (2026-09-25) — the eight YAML control kinds and `tesserae.widgets`' stateful factories are Tesserae's controls (bindings, `two_way:`, reconcile, `group:`); the todo_list checkbox ticks; 1157 → 1179. Before that, M40 Phase 4 (same day) — progress, loading, the time picker dial.
