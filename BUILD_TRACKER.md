...
| M38 — MD3 Theme in Tesserae | `█████░░░░░` 50% | 🚧 In progress — Phase 2 of 4 done (2026-09-25) |
...
**Status: 🚧 In progress — Phase 2 of 4 done (2026-09-25).** User: "push it and scope M38"; decisions Q1–Q4 made (below). `tre` D7: `tre` keeps no theme concept. Smaller than first planned: M37 Phase 1 brought the static tokens forward (colour roles, shape, elevation as `shadows`, the type scale, colour parsing), and live re-theming already works through `View.set_theme` and `App.set_theme_specs`.
